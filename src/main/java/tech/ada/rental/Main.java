...
import tech.ada.rental.controller.ClienteControllerImpl;
import tech.ada.rental.controller.Controller;
...
public class Main {
    public static void main(String[] args) throws VeiculoIndisponivelException, ElementoNaoEncotradoException, ElementosDuplicadosException {

        Controller clienteControllercontroller = new ClienteControllerImpl(new ClienteService(new ClienteRepositoryImpl()));


        clienteControllercontroller.criar(new Cliente("Moises Almeida",
                    "moises@me.com",
                    "11 99999-9999",
                    "11111111111",
                    "11111111111",
        ...
        System.out.println(clienteControllercontroller.listar());
